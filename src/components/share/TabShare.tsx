...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful period calculator tool, check it out: https://seosaurus.in/tools/period-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/period-calculator/";
